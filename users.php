      ...
      <form method="post" id="userForm">
        ...
        <div class="modal-body">
            ...
            <div class="row g-2">
                ...
                <div class="col-md-6"><label class="form-label">Role</label><select class="form-select" name="role" id="role"><option value="administrator">Administrator</option><option value="dsm_admin">DSM Admin</option><option value="state_dsm">State DSM</option><option value="crm_member">CRM Member</option><option value="district_user">District User</option></select></div>
